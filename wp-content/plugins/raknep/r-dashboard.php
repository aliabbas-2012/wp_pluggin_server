				...
				foreach($rows as $row){
					?>
						...
						<tr>
							...
							<td> <span class="wp-rankie-rank-<?php echo $row->keyword_id ?>"  ><?php echo $row->keyword_rank ?></span></td>
	    ...
	    <div class="tabs-panel" id="category-all" style="display: none;">
	         ...
	         <div class="wp-rankie-chart-contain">
		         <table class="widefat"  id="wp-rakie-chart" >
					<caption>Ranking Records of "<span class="wp-rakie-chart-site">SITE</span>" on keyword "<span class="wp-rakie-chart-keyword">KEYWORD</span>" </caption>
					<thead>
						<tr>
							<th>Date</th> 
							<th>Rank</th>
